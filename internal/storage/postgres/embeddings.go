...
// 2026-09-26). Contract stub: every method reports errors.ErrUnsupported
// until the per-model index lands.
...
func errEmbeddingsUnsupported(op string) error {
	return fmt.Errorf("postgres embeddings %s: %w", op, errors.ErrUnsupported)
}
