...
# single-use grade:ctxt token into a throwaway claims DB, uploads
# every cassette under e2e/conformance/cassettes/ at tier 3, and
# prints the per-scenario verdicts plus a per-factor rollup.
#
# Requirements:
