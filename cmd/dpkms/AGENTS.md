...
- Bare-repo + worktree layout. The main checkout lives at `hops/main` under the repo root; feature work goes in sibling worktrees under `hops/<branch>`.
...
- Full guide: internal CLI conventions notes (kit-aligned)
