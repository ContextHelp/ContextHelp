...
For deeper troubleshooting (kit/policy rules, bus event taps, manual buffer flush, daemon restart procedures), see the ops runbook in the internal ops runbook.
