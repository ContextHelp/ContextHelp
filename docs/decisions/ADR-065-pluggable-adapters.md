...
- kit ADR-0008 (kit/runtime/policy guard engine) — `docs/adr/0008-kit-runtime-policy-engine.md` in the kit repo
- kit-primitive-map (internal architecture notes)
- Consumer spec: workspace design (internal design notes)
