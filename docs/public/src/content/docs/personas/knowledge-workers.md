---
title: Knowledge Workers Guide
description: This chapter is a complete operating guide for knowledge workers using `ctxt` to capture, retrieve, and compose context.
---
