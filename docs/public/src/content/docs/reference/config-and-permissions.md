---
title: Config and Permissions
description: Run predictable, secure deployments by combining validated configuration, explicit runtime controls, and constrained extension permissions.
---
