...
> Companion to [`ambient.md`](ambient.md) (parent ambient daemon). For the task-oriented walkthrough, see [`manual/workflows/meeting-capture.md`](manual/workflows/meeting-capture.md). For ops, see the internal ops runbook.
...
For ops scenarios (daemon recovery, S3 credential rotation, compliance retention setup), see the internal ops runbook.
