...
This document lists all domains within the **dPKMS** (Decentralized Personal Knowledge Management Substrate) package, organized by responsibility.
...
**dPKMS** is the substrate layer providing mechanical guarantees for knowledge management:
- Storage, durability, and correctness
- Job queue and pipeline execution
- Security, privacy, and federation
- Query engine and ranking
- Graph indexes and embeddings

Together with **`ctxt`** (the brain layer), they provide **context-as-a-service** for humans and AI agents.
...
# Total: 15 dPKMS Domains

For the complete system architecture including ctxt domains and cross-cutting concerns, see:
- **ctxt domains:** `docs/ctxt/domains.md`
