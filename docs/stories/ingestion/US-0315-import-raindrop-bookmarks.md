...
As a knowledge worker, I want to import data from Raindrop.io collections and bookmark items so I can make existing knowledge searchable in ctxt without manual copy/paste.
...
- [ ] Importer accepts Raindrop.io collections and bookmark items as input and validates required configuration.
- [ ] Auth flow supports OAuth 2.0 with Raindrop.
- [ ] Importer supports first-time backfill and incremental sync using item updated timestamp cursor.
- [ ] Imported records map to object types: bookmarks, collections, tags, highlights.
...
- Example: ctxt import raindrop --profile default --since 2026-01-01
...
- Default pipeline for this story: import.raindrop
...
- POST /api/v1/importers/raindrop/run
