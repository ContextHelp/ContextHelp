...
As a knowledge worker, I want to import data from Chrome bookmarks HTML exports so I can make existing knowledge searchable in ctxt without manual copy/paste.
...
- [ ] Importer accepts Chrome bookmarks HTML exports as input and validates required configuration.
...
- Example: ctxt import chrome --file ./bookmarks.html --profile default
...
- Default pipeline for this story: import.chrome
...
- POST /api/v1/importers/chrome/run
...
- [Importer Plan](../../plans/2026-02-18-importer-chrome-plan.md) — Source-specific plan
